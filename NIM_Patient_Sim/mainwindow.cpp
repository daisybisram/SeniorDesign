    ...
    , ui(new Ui::MainWindow)
{
    ...
    uint16_t EMG_data[400] = {0x837F,0x8384,0x83BA,0x8417,0x8488,0x84F3,0x854C,0x858F,0x85C3,0x85EF,0x8619,0x863D,0x8655,0x865B,0x864C,0x862E,
                              ...
                              0xA4CB,0xB253,0xC07E,0xCF28,0xDDDB,0xEB8D,0xF6BC,0xFDDD,0x0000,0xFD46,0xF6E1,0xEE91,0xE5D8,0xDD51,0xD493,0xCA97,
    ...
    spiControl->DAC_output(DAC_OUT0_ADDR, EMG_data, 0, 0);
